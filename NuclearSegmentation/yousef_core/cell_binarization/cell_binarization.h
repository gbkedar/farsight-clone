...
int Cell_Binarization_3D(unsigned short *imgIn, unsigned short* imgOut, int R, int C, int Z, int shd, int div, unsigned short number_of_bins, float alpha_F=0, float alpha_B=0, float P_I=0); 
